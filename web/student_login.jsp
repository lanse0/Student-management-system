...
<body>
    ...
    <div id="login">
        ...
        <form action="${pageContext.request.contextPath}/StudentLoginServlet" method="post">
            ...
            <div class="form-group clearfix">
                <input type="text" class="form-control code" id="code" name="code" placeholder="输入验证码">
                <img src="verifyCode" id="verifyCode" onclick="changeCode()">
                <span class="msg">${requestScope.codeError}${requestScope.codeMsg}</span>
            </div>
            <div align="center">
    ...
    <script>
        function changeCode(){
            document.getElementById("verifyCode").src="verifyCode?id="+Math.random();
        }
    </script>
</body>
</html>